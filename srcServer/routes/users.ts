...
import { DeleteCommand, ScanCommand, GetCommand, type ScanCommandOutput } from '@aws-sdk/lib-dynamodb';
...
router.delete('/me', authMiddleware, async (req: AuthedRequest, res: Response<ResponseMessage>) => {
  try {
